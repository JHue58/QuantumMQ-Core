...
import (
	"QuantumMQ-Core/internal/qnet/connect"
	"QuantumMQ-Core/internal/qnet/qc"
	"QuantumMQ-Core/pkg/errors"
	goroutine2 "QuantumMQ-Core/pkg/goroutine"
	cmap "github.com/orcaman/concurrent-map/v2"
	"time"
)

var msgLife = goroutine2.Group("msgLife")
var sendH = goroutine2.Group("sendH")
...
func (q *QTPWriter) Start() {
	goroutine2.CheckAndGetters(func() any {
		return q.GetQTPConn()
	}, func() any {
